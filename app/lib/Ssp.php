...
class Ssp {
     ...
     */
    static function filter($request, $columns, &$bindings, $pdo) {
        $globalSearch = array();
        $columnSearch = array();
        $dtColumns = self::pluck($columns, 'dt');
     ...
     */
    static function simple($request, $table, $primaryKey, $columns, $pdo) {
        ...
        $where = self::filter($request, $columns, $bindings, $pdo);
     ...
     */
    static function sql_connect($pdo) {
        try {
